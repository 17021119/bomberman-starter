...
public class Bomber extends Character {
    ...
    private void detectPlaceBomb() {
        ...
        if (this._input.space && Game.getBombRate() > 0 && _timeBetweenPutBombs < 0) {
            ...
            play.playMusic("res\\sound\\place.wav");
            Game.addBombRate(-1);
    ...
    protected void calculateMove() {
        ...
        if(_input.up) move(0,-speed);
        else if(_input.down) move(0,speed);
        else if(_input.right) move(speed,0);
        else if(_input.left) move(-speed,0);
        else _moving=false;
    }
    ...
    public boolean canMove(double x, double y) {
        ...
        for (int around = 0; around<4; around++){
            ...
            if(check.collide(this)==false) return false;
        }
        return true;
    }
    ...
    public boolean collide(Entity e) {
        ...
        if(e instanceof Flame || e instanceof Enemy) {
            this.kill();
            play.playMusic("res\\sound\\die.wav");
            return true;
